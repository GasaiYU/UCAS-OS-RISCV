...
void map_page(uint64_t va, uint64_t pa, PTE *pgdir)
{
    ...
    if (pgdir[vpn2] == 0) {
        ...
        //This function aims to fill pgdir[vpn2]'s ppn field with new_addr
        set_pfn(&pgdir[vpn2], alloc_page() >> NORMAL_PAGE_SHIFT);       
        //This function aims to set the valid field 1
        set_attribute(&pgdir[vpn2], _PAGE_PRESENT);
        //This function aims to clear the page just alloced
